      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto mb-10 flex max-w-2xl flex-col p-5">
          ...
          <label className="mb-5 block">
            ...
            <input {...register("name", { required: true })} className="form-input mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-green-500 focus:ring" placeholder="John Connor" type="text" />
          </label>
          <label className="mb-5 block">
            <span className="text-gray-700 ">Email</span>
            <input {...register("email", { required: true })} className="form-input mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-green-500 focus:ring" placeholder="your@email.com" type="email" />
          </label>
          <label className="mb-5 block">
            <span className="text-gray-700 ">Comment</span>
            <textarea {...register("comment", { required: true })} className="form-textarea mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-green-500 focus:ring" placeholder="Enter some long form comment" rows={8} />
          </label>
          ...
          <input type="submit" className="focus:shadow-outline cursor:pointer rounded bg-green-500 py-2 px-4 font-bold text-white shadow hover:bg-green-400 focus:outline-none" />
        </form>
      )}
